...
reomp_test_t reomp_test_cases[] =
  {
    {(char*)"omp_critical", reomp_test_omp_critical,   {0, 0,    300}},
    {(char*)"omp_atomic", reomp_test_omp_atomic,       {0, 0,   300}},
    {(char*)"data_race", reomp_test_data_race,         {0, 0,   300}},
    {(char*)"omp_reduction", reomp_test_omp_reduction, {0, 0,  300}},
  };
