...
PreservedAnalyses HelloWorldClass::run(Function& F, FunctionAnalysisManager&) {
...
bool HelloWorldClass::isRequired() { return true; }

void HelloWorldClass::insert_func(Instruction* I, BasicBlock* BB, int offset, int control, Value* ptr, Value* size)
{
...
/* Outer Handlers */
int HelloWorldClass::handle_function(Function& F)
{
...
int HelloWorldClass::handle_basicblock(Function& F, BasicBlock& BB)
{
    return 0;
}
...
int HelloWorldClass::handle_function_on_main(Function& F)
{
    int modified_counter = 0;
...
int HelloWorldClass::handle_instruction(Function& F, BasicBlock& BB, Instruction& I)
{
...
int HelloWorldClass::handle_instruction_on_reduction(Function& F, BasicBlock& BB, Instruction& I)
{
...
int HelloWorldClass::handle_instruction_on_critical(Function& F, BasicBlock& BB, Instruction& I)
{
...
int HelloWorldClass::is_data_racy_access(Function* F, Instruction* I, uint64_t* access)
{
...
int HelloWorldClass::handle_instruction_on_load_store(Function& F, BasicBlock& BB, Instruction& I)
{
...
void HelloWorldClass::init_inserted_functions(Module& M)
{
...
llvm::PassPluginLibraryInfo getHelloWorldPluginInfo() {
    return { LLVM_PLUGIN_API_VERSION, "HelloWorldClass", LLVM_VERSION_STRING,
            [](PassBuilder& PB) {
              ...
              PB.registerPipelineStartEPCallback(
                [](ModulePassManager& MPM, OptimizationLevel Level) {
                   ...
                   std::unique_ptr<HelloWorldClass> hwobj = std::make_unique<HelloWorldClass>();
